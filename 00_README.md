...
invSLR: first version (with minimal error checking of inputs) of an inverse function for SLR balances (logratios of amalggamated parts) -- this function is now incorporated into easyCODA along with the error-checking
